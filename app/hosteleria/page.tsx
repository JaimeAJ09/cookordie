...
export default function Hosteleria() {
  ...
  <>
    ...
    <main className="bg-[#FFF7EC] text-[#1A1A1A] font-inter">
      ...
      {/*IMAGEN*/}
          <div className='relative w-[430px] md:w-[450px] h-[300px] md:h-[360px] rounded-3xl overflow-hidden bg-gray-200 shadow-2xl'>
            {/*AQUI VA LA IMAGEN*/}
      ...
      <section className="px-6 md:px-20 py-24 pt-0">
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
          ...
          <div className='relative w-[430px] md:w-[450px] h-[300px] md:h-[360px] rounded-3xl overflow-hidden bg-gray-200 order-2 lgorder-1 shadow-2xl'>
            {/*AQUI VA LA IMAGEN*/}
